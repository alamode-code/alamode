...
void dgglse_(const int *M, const int *N, const int *P,
             ...
             double *C, double *D,
             double *X, double *WORK, const int *LWORK,
             int *INFO);
...
void dgesdd_(
    char *jobz,   // 'A' to compute all columns of U and rows of VT
...
void dgemv_(
    char *trans, // 'N' for A*x, 'T' for A^T*x
    int *m,      // number of rows of A
    int *n,      // number of columns of A
    double *alpha,
...
void dgels_(
    char *trans,  // 'N' for A*X=B, 'T' for A^T*X=B
    int *m,       // number of rows of A
    int *n,       // number of columns of A
