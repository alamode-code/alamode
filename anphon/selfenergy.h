...
// scalars are stored once by setup_selfenergy (called from
...
public:
    ...
    void setup_selfenergy(unsigned int ns_in, double epsilon_in, bool classical_in, int my_rank_in, int nprocs_in);
    ...
    void selfenergy_c_mod(const unsigned int N, const double *T, const double omega, const unsigned int knum,
                          const unsigned int snum, const KpointMeshUniform *kmesh_in, const double *const *eval_in,
                          const std::complex<double> *const *const *evec_in, AnharmonicCore &anharmonic_core,
                          const std::vector<SymmetryOperation> &symmlist, std::complex<double> *ret) const;
    ...
    get_bubble_selfenergy(const KpointMeshUniform *kmesh_in, const unsigned int ns_in, const double *const *eval_in,
                          const std::complex<double> *const *const *evec_in, const unsigned int knum,
                          const unsigned int snum, const double temp_in,
                          const std::vector<std::complex<double>> &omegalist, const PhaseFactorCache *phase_cache_in,
                          AnharmonicCore &anharmonic_core) const;
