...
{
public:
    static void write_header(std::fstream &fs_result, const std::string &file_result, const KpointMeshUniform *kmesh_in,
                             const Cell &primcell, bool with_cell_geometry, const bool classical_in,
                             const int ismear_in, const double epsilon_in, const double tmin_in, const double tmax_in,
    ...
    static void load_gamma_blocks(std::fstream &fs_result, const std::string &file_result, const unsigned int nk_irred,
                                  const unsigned int ns, const unsigned int ntemp, double **damping,
                                  std::vector<int> &vks_done_out, const char *label, const bool allow_truncate);
    ...
    static void write_ibte_Q_dF_block(std::fstream &fs_result, const double etemp, const KpointMeshUniform *kmesh_in,
                                      const double *const *Q_all, const double *const *const *df,
                                      const unsigned int ns);
};
} // namespace PHON_NS
